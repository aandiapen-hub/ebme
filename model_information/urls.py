...
urlpatterns = [
    ...
    path("software/",SoftwareFilterView.as_view(),name='softwares'),
    path("software/<int:pk>/update",SoftwareUpdateView.as_view(),name='software_update'),
    path("software/create",SoftwareCreateView.as_view(),name='software_create'),
