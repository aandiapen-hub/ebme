...
class TblExpenses(models.Model):
    ...
    status = models.ForeignKey(
        TblExpenseStatus, models.PROTECT, db_column="status", blank=True, null=True
    )
...
class TblInvoices(models.Model):
    ...
    document_links = GenericRelation(
        "documents.TblDocumentLinks", related_query_name="invoices"
    )
...
class TblPoLines(models.Model):
    ...
    line_price_incl_vat = models.DecimalField(
        max_digits=12, decimal_places=4, blank=True, null=True
    )
    ...
    order_unit_id = models.ForeignKey(
        TblOrderUnit, models.PROTECT, db_column="order_unit_id", blank=True, default=0
    )
...
class TblPurchaseOrder(models.Model):
    ...
    ship_to_add = models.ForeignKey(
        "TblDeliveryAddresses", models.PROTECT, blank=True, null=True
    )
    ...
    order_status = models.ForeignKey(
        TblOrderStatus, models.PROTECT, blank=True, null=True
    )
    vat_amount = models.DecimalField(
        max_digits=12, decimal_places=4, blank=True, null=True
    )
...
class PoView(models.Model):
    ...
    supplier_id = models.ForeignKey(
        "TblSuppliers", models.PROTECT, blank=True, null=True, db_column="supplier_id"
    )
    date_raised = models.DateField(blank=True, null=True)
    ship_to_add_id = models.ForeignKey(
        "TblDeliveryAddresses",
        models.PROTECT,
        blank=True,
        null=True,
        db_column="ship_to_add_id",
    )
    sub_total = models.DecimalField(
        max_digits=12, decimal_places=4, blank=True, null=True
    )
...
class TblDeliveries(models.Model):
    ...
    document_links = GenericRelation(
        "documents.TblDocumentLinks", related_query_name="deliveries"
    )
